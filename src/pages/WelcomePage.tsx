...
import SoundControlButton from "../components/SoundControl/SoundControlButton";
...
const WelcomePage = () => {
  ...
  }, []); // fire once on mount — locale at page load is the relevant value

  const toggleInfo = () => {
    const newVisible = !isInfoVisible;
    setIsInfoVisible(newVisible);
    track(EVENTS.EXERCISE_INFO_TOGGLED, { locale, screen, value: newVisible });
  };
